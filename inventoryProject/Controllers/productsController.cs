...
namespace inventoryProject.Controllers
{
    public class productsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "product_id,product_name,product_type_id,sale_price,photo")] product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "product_id,product_name,product_type_id,sale_price,photo")] product product)
        {
            if (ModelState.IsValid)
            {
